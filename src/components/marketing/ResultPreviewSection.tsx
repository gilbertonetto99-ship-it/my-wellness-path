...
export function ResultPreviewSection() {
  return (
    <section className="py-20 sm:py-24 lg:py-30" aria-labelledby="preview-title">
      <MarketingContainer>
        <div className="overflow-hidden rounded-[2rem] border border-primary/12 bg-primary text-primary-foreground shadow-[0_40px_90px_-50px_rgba(23,62,53,.8)]">
          <div className="grid gap-10 p-6 sm:p-10 lg:grid-cols-[.9fr_1.1fr] lg:items-center lg:p-14">
            <div>
              ...
              >
                See What Your Realistic Starting Plan Could Look Like.
              </h2>
              <p className="mt-5 max-w-xl text-base leading-8 text-primary-foreground/76 sm:text-lg">
                Your answers help us highlight a starting pace, your biggest consistency barrier,
                and a practical next step for your first week.
              </p>
              <MarketingCTA className="mt-7 bg-primary-foreground text-primary shadow-[0_18px_36px_-20px_rgba(0,0,0,.55)] hover:brightness-95" />
            </div>
            ...
            <div className="rounded-[1.6rem] border border-white/15 bg-white/[0.08] p-4 backdrop-blur-sm sm:p-6">
              ...
              <div className="mt-5 grid gap-3">
                {PREVIEW_ITEMS.map(({ icon: Icon, label, value }) => (
                  <div
                    key={label}
                    className="flex items-start gap-4 rounded-2xl bg-white/[0.09] p-4"
                  >
