...
const MOMENTS = ["Move more naturally", "Stand a little taller", "Feel more alive in your day"];
    ...
    >
      <MarketingContainer>
        <div className="premium-feature-card grid overflow-hidden rounded-[2rem] border border-border bg-card shadow-[0_35px_90px_-58px_rgba(23,62,53,.55)] lg:grid-cols-[1.08fr_.92fr]">
          <div className="relative min-h-[390px] lg:min-h-[610px]">
            <img
            ...
            />
            <div className="absolute inset-x-5 bottom-5 rounded-2xl border border-white/25 bg-primary/82 p-5 text-primary-foreground backdrop-blur-md sm:inset-x-8 sm:bottom-8">
          ...
          <div className="flex flex-col justify-center p-7 sm:p-10 lg:p-14">
            ...
            >
              Feel Younger in the Way You Live.
            </h2>
            <p className="mt-5 text-lg leading-8 text-muted-foreground">
              Rediscover the confidence, energy, and pleasure of moving in a way that feels like
              you.
            </p>
